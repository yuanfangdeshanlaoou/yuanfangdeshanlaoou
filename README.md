...
### 🧰 技术栈
`Python` `radare2` `frida` `nuclei` `semgrep` `gitleaks` `osv-scanner` `Burp Suite` `MQTT/CoAP协议分析` `污点追踪`

### 🎯 当前进行
- SRC漏洞挖掘（补天平台）
- CTF备赛（Web / Misc / Reverse方向）
- 安全研究技术文章沉淀中

### 📫 联系
- 邮箱: [oioio888@qq.com](mailto:oioio888@qq.com)
- 漏洞报告 / 研究合作请优先邮件，见各仓库 SECURITY.md
